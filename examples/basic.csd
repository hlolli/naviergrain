...
kControl[$NG_CONTROL_GAIN] = .12
kControl[$NG_CONTROL_POSITION_CENTER] linseg .1, p3*.5, .8, p3*.5, .3
kControl[$NG_CONTROL_GRAIN_RATE] expseg 18, p3*.5, 170, p3*.5, 35
kControl[$NG_CONTROL_GRAIN_MS] linseg 180, p3, 35
...
printks "preview: grains=%d pre-limiter peak=%.4f\n", 1, kStats[$NG_STAT_LIVE_GRAINS], kStats[$NG_STAT_PRE_LIMITER_PEAK]
endin
</CsInstruments>
<CsScore>
i 1 0 8
