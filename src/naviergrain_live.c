...
void ng_live_defaults(double out[24]) {
  ...
  out[NG_CONTROL_GAIN]=.06;out[NG_CONTROL_GRAIN_RATE]=700;
  out[NG_CONTROL_GRAIN_MS]=180;out[NG_CONTROL_DRIVE]=.3;
  out[NG_CONTROL_TURBULENCE]=.05;out[NG_CONTROL_FLOW_SPEED]=.35;
  out[NG_CONTROL_STRAIN_TO_DURATION]=.2;
