#ifndef FLUIDGRAIN_OSCILLATOR_H
#define FLUIDGRAIN_OSCILLATOR_H
#include <math.h>
...
static inline double fg_osc_sin(double x) {
...
static inline double fg_osc_cos(double x) {return fg_osc_sin(x+1.57079632679489661923);}
...
static inline double fg_osc_pitch(double x) {
